 ...
 * @copyright 2018 Andrey Kvasnevskiy-OrdaSoft(akbet@mail.ru); Rob de Cleen(rob@decleen.com);
  ...
  if(count($house_photos) > 0) { ?>
    ...
    <?php for ($i = 0; $i < count($house_photos); $i++) : ?>
        ...
        $house_photos[$i]->main_img = str_ireplace('watermark/', '', $house_photos[$i]->main_img);
          ...
          $file_name = rem_picture_thumbnail($house_photos[$i]->main_img, $realestatemanager_configuration['fotomain']['high'], 
               $realestatemanager_configuration['fotomain']['width'], $watermark);    
            $img_path = 'components/com_realestatemanager/photos/';
            if($watermark){
                  $href = $mosConfig_live_site . '/components/com_realestatemanager/photos/watermark/' . $house_photos[$i]->main_img;
              }else{
                  $href = $mosConfig_live_site . '/components/com_realestatemanager/photos/' . $house_photos[$i]->main_img;
              }
         ?> 

            <a href="<?php echo $href; ?>" data-fancybox="slider" title="photo">
...
<?php
          ...
          if ($house->listing_status){
            ...
            if($watermark){
              $href = $mosConfig_live_site . '/components/com_realestatemanager/photos/watermark/' . $imageURL;
          }else{
              $href = $mosConfig_live_site . '/components/com_realestatemanager/photos/' . $imageURL;
          }

          echo '<a  href="'.$href.'" data-fancybox="gallery"><img alt="' . $house->htitle . '" title="' . $house->htitle . '" src="' . $file . '"  ></a>';
        ...
        <div class="thumbnail viewHouses" 
         ...
         <?php $house_photos[$i]->main_img = str_ireplace('watermark/', '', $house_photos[$i]->main_img) ?>
              ...
              <a href="./components/com_realestatemanager/photos/<?php 
               echo $house_photos[$i]->main_img; ?>" data-fancybox="gallery" title="photo" >
