...
* @version      $Id: animation.php  kiennh $ 
* @author       Omegatheme
...
?> 
<div class="newsgrid-content">
    <section class="grid3d <?php echo $params->get('grid_style') ?>" id="grid3d<?php echo $module->id;?>">
        <div class="grid-wrap">
            <div class="grid">    
                <?php require JModuleHelper::getLayoutPath('mod_newsgrid', 'animation_ajax');?>   
            </div>
        </div>
        <div class="content">       
	...
	*/
    ...
    <div class="timeline_footer">
        ...
        <a href="//wwww.omegatheme.com/joomla-templates" class="powered" title="Joomla Module News Grid powered by OmegaTheme.com">
            <img src="//omegatheme.com/images/logo_embed.png"  title="Joomla Module News Grid powered by OmegaTheme.com"  alt="Joomla Module News Grid powered by OmegaTheme.com">
        </a>
        <?php /*********/ ?>
    </div>
</div>
<script src="<?php echo Juri::base(); ?>modules/mod_newsgrid/assets/js/modernizr.custom.js"></script> 
